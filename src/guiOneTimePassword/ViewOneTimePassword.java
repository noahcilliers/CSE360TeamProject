 ...
 * 
 * <p> Description: The Java/FX-based page for giving a user a one time password .</p>
 * 
...
public class ViewOneTimePassword {
	...
	*/
	...
	//test TextField
	//private static TextField text_Test = new TextField();
    ...
    protected static Label label_OneTimePasText = new Label("Enter New One Time Password For The Selected User:");
    protected static Button button_SetOneTimePas = new Button("Set One Time Pass");
	...
	protected static Label label_SelectUser = new Label("Select a user to give one time password:");
	...
	*/
	...
	public ViewOneTimePassword() {
		...
		setupComboBoxUI(combobox_SelectUser, "Dialog", 16, 250, 390, 125);
    	...
    	.addListener((@SuppressWarnings("unused") ObservableValue<? extends String> observable, 
    		...
    		@SuppressWarnings("unused") String newValue) -> {ControllerOneTimePassword.doSelectUser();});
				...
				// Base x and y values for one time password screen
				float xPos = 20;
				float yPos = 200;
				// Text box UI
				setupLabelUI(label_OneTimePasText, "Arial", 20, 300, Pos.BASELINE_LEFT, xPos , yPos);
				// Establish the text input operand field for the password
				setupTextUI(text_Password1, "Arial", 18, 300, Pos.BASELINE_LEFT, xPos, yPos + 50, true);
				text_Password1.setPromptText("Enter the Password");
				// Establish the text input operand field to confirm the password
				setupTextUI(text_Password2, "Arial", 18, 300, Pos.BASELINE_LEFT, xPos, yPos + 100, true);
				text_Password2.setPromptText("Enter the Password Again");
				// Button UI
					
				setupButtonUI(button_SetOneTimePas, "Dialog", 16, 150, Pos.BASELINE_LEFT, xPos + 400, yPos + 75);
				ViewOneTimePassword.button_SetOneTimePas.setOnAction((_) -> 
					{ControllerOneTimePassword.performOneTimePass(); });
