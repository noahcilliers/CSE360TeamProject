 ...
 */
	 ...
	 * 
	 * <p> Description: Get the oneTimePassword of a user given that user's username.</p>
	 * 
	 * @param username is the username of the user
	 * 
	 * @return the oneTimePassword of a user given that user's username 
	 *  
	 */
	// Get the password
	public String getOneTimePassword(String username) {
		...
		try (PreparedStatement pstmt = connection.prepareStatement(query)) {
	        ...
	        ResultSet rs = pstmt.executeQuery();  
	        if (rs.next()) {
	            return rs.getString("oneTimePassword"); // Return the first name if user exists
	        }	
	    } catch (SQLException e) {
	        e.printStackTrace();
	    }
	...
	/*******
	 * <p> Method: void updateOneTimePassword(String username, String oneTimePassword) </p>
	 * 
	 * <p> Description: Update the oneTimePassword of a user given that user's username and the new
	 *		oneTimePassword.</p>
	 * 
	 * @param username is the username of the user
	 * 
	 * @param oneTimePassword is the new oneTimePassword for the user
	 *  
	 */
	public void updateOneTimePassword(String username, String oneTimePassword) {
	...
	public boolean getUserAccountDetails(String username) {
		...
		try (PreparedStatement pstmt = connection.prepareStatement(query)) {
	    	...
	    	currentOneTimePassword = rs.getString(9);
